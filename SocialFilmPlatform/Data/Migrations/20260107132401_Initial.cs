    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiaryVotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiaryVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiaryVotes_Diaries_DiaryId",
                        column: x => x.DiaryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiaryId = table.Column<int>(type: "int", nullable: false),
                    DiaryTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieDiaries", x => new { x.Id, x.MovieId, x.DiaryId });
                    table.ForeignKey(
                        name: "FK_MovieDiaries_Diaries_DiaryId",
                        column: x => x.DiaryId,
                        principalTable: "Diaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieDiaries_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiaryVotes_DiaryId_UserId",
                table: "DiaryVotes",
                columns: new[] { "DiaryId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DiaryVotes_UserId",
                table: "DiaryVotes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieDiaries_DiaryId",
                table: "MovieDiaries",
                column: "DiaryId");
